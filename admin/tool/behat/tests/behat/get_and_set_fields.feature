...
Feature: Verify that all form fields values can be get and set
  ...
  Background:
    ...
    And the following "activities" exist:
      | activity | name             | intro                   | course | idnumber | option | allowupdate | section |
      | choice   | Test choice name | Test choice description | C1     | choice1  | Option 1, Option 2, Option 3 | 1 | 1 |
    And I am on "Course 1" course homepage
