...
Feature: The activity results block displays student scores
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | assign     | Test assignment 1   | Offline text   | C1     | 1       | assign1 |
      | assign     | Test assignment 2   | Offline text   | C1     | 1       | assign2 |
      | assign     | Test assignment 3   | Offline text   | C1     | 1       | assign3 |
    And the following "activities" exist:
