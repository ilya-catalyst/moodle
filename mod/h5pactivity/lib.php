...
function h5pactivity_print_recent_activity($course, $viewfullnames, $timestart) {
    ...
    foreach ($submissions as $submission) {
        ...
        $groupinfo = h5pactivity_getgroupinfo($submission->userid, $modinfo, $course, $context,
 ...
 * @return void
 */
function h5pactivity_get_recent_mod_activity(&$activities, &$index, $timestart, $courseid,
    ...
    foreach ($submissions as $submission) {
        ...
        $groupinfo = h5pactivity_getgroupinfo($submission->userid, $modinfo, $course, $cmcontext,
            $cm, $groupinfo['groups'], $groupinfo['usersgroups']);
...
function h5pactivity_print_recent_mod_activity($activity, $courseid, $detail, $modnames) {
    ...
    if ($detail) {
        ...
        $modinfo['modurl'] = new moodle_url('/mod/h5pactivity/view.php', array('id' => $activity->cmid));
 ...
 * @return array
 */
function h5pactivity_getgroupinfo($userid, $modinfo, $course, $context, $cm, $groups, $usersgroups) {
